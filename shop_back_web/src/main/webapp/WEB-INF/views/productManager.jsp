...
<head>
    ...
    <script>
        $(function(){
            ...
            //使用validator插件进行表单校验
            $('#addProductForm').bootstrapValidator({//里面是json数组，嵌套了很多层的
                feedbackIcons:{//验证结果图标
                    valid:'glyphicon glyphicon-ok',
                    invalid:'glyphicon glyphicon-remove',
                    validating:'glyphicon glyphicon-refresh'
                },
                fields:{//对每一个表单元素校验，key为name
                    name:{
                        validators:{
                            notEmpty:{
                                message:'不能为空',
                            ...
                            remote:{
                                type:"post",
                                url:"${pageContext.request.contextPath}/back/product/nameExsit",
                            }
                        }
                    }
                }
...
<div class="modal fade" tabindex="-1" id="Product">
    ...
    <div class="modal-dialog modal-lg">
        <!-- 内容声明 -->
        <form action="${pageContext.request.contextPath}/back/product/addProduct" enctype="multipart/form-data" class="form-horizontal" method="post" id="addProductForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="productTypeId">
                                    <c:forEach var="prodcutType" items="${prodcutTypes}">
                                        <option value="${prodcutType.id}">${prodcutType.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
